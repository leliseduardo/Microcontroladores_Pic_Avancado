/* 
        ...
        O objetivo deste programa é demonstrar como são feitos sub menus. A partir dos dois últimos projetos, denominados "LCDMenusFuncionais" e
     "LCDMenusFuncionais2", neste programa serão feitos três sub menus para o menu 1. Estes sub menus mostrarão a temperatura máxima registrada,
     a mínima e a média delas, resperctivamente.
        Para a aplicação deste projeto será adicionado um botão, denominado "enter", que servirá para navegar entre os sub menus de um mesmo menu.
        Este programa serve como base para a aplicação de menus e sub menus em vários outros projetos, onde se tem um IHM controlando um circuito
     embarcado.

        Tanto na simulaçãodo proteus quanto na prática, o ciruito e o programa funcionaram perfeitamente.
        
        A partir deste programa eu tenho o básico para implementar menus e sub menus no LCd em diversos outros projetos, fazendo assim com que
     as aplicações fiquem organizadas e cada vez mais fáceis de serem controladas e supervisionadas.

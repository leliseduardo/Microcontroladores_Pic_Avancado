/* 
        ...
        O objetivo deste programa é implementar um voltímetro com o conversor AD e salvar as tensões máximas e mínimas. Para isso utiliza-se uma
    EEPROM externa. As tensões lidas terão uma tensão máxima de leitura de 5V. O programa funcionará de forma que, quando ligado, mostra a tensão
    máxima e mínima por um tempo e depois desse tempo mostra a leitura que está sendo feita intantâneamente.
        Como base utiliza-se o código do projeto passado, denominado "EEPROMExternaADC".
...
void EEPROM_Escreve16bits(unsigned char endereco, unsigned dado){
      ...
      I2C1_Wr(endereco);             // Envia a posição de memória a ser escrita
...
void EEPROM_Leitura16bits(){
     ...
     I2C1_Start();              // Inicializa o I2C
     I2C1_Wr(0xA0);             // Envia um byte para o I2C contendo o endereço e configurando escreita  (device address + W)
     I2C1_Wr(0x07);             // Envia a posição de memória a ser escrita
     I2C1_Repeated_Start();     // Reinicia o I2C
     I2C1_Wr(0xA1);             // Envia um byte para o I2C contendo o endereço e configurando leitura
     memoriaH = I2C1_Rd(0u); // Le o dado e armazena na variável memoria
     I2C1_Stop();               // Para o I2C
     ...
     I2C1_Start();              // Inicializa o I2C
     I2C1_Wr(0xA0);             // Envia um byte para o I2C contendo o endereço e configurando escreita  (device address + W)
     I2C1_Wr(0x08);             // Envia a posição de memória a ser escrita
     I2C1_Repeated_Start();     // Reinicia o I2C
     I2C1_Wr(0xA1);             // Envia um byte para o I2C contendo o endereço e configurando leitura
     memoriaL = I2C1_Rd(0u);// Le o dado e armazena na variável memoria
     I2C1_Stop();

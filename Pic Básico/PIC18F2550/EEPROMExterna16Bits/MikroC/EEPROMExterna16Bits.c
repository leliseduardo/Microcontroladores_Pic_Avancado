/* 
        ...
        O objetivo deste código é demonstrar como gravar dados de 16 bits na memória EEPROM externa. Sabe-se que cada endereço de memória da
    EEPROM contém apenas 8 bits, mas com uma manipulação de variáveis consegue-se gravar uma variável de 16 bits.
